      ...
      <div className="flex flex-col gap-[40px]">
        <div className="text-[14px] text-textColor leading-[1.7]">
          {t(
            ...
            'Create an OAuth App to let other Planna users authorize your product to post on their behalf.'
          )}
          <br />
          {t(
        ...
        <div className="bg-newBgColorInner rounded-[12px] border border-newBorder overflow-hidden">
          <div className="bg-newBgColorInner px-[20px] py-[14px] border-b border-newBorder flex items-start justify-between gap-[12px]">
            <div>
              ...
              <div className="text-[13px] text-customColor18 mt-[2px]">
                {t(
                  ...
                  'Create an OAuth application to allow third-party integrations with Planna on behalf of your users.'
                )}
              </div>
            </div>
            <div className="flex gap-[6px] shrink-0 pt-[2px]">
              <a
                ...
                href="https://docs.planna.com/public-api/oauth"
                target="_blank"
              >
          ...
          <div className="p-[20px]">
            <button
              ...
              className="cursor-pointer px-[20px] h-[44px] bg-[#ff6600] hover:bg-[#5520CB] transition-colors text-white rounded-[8px] text-[15px] font-[600]"
            >
